...
//    //std::cout << "mesh����:    " << ourModel.meshes.size() << endl;    
//   /* for (int i = 0; i < 2; i++)
//    {
//        for (int j = 0; j < 3; j++)
//        {
//            glm::vec3 p = ourModel.meshes[0].triangles[i].vertex[j].Position;
...
//        for (int j = 0; j < 3; j++)
//        {
//            glm::vec3 p = ourModel.meshes[0].triangles[i].vertex[j].Normal;
//            std::cout << p.x<< "    "<<p.y <<"   "<<p.z  << endl;
//        }
//    }*/
//
//    //glm::vec3 aa = ourModel.meshes[0].myBVH.nodes[0].AA;
//    //glm::vec3 bb = ourModel.meshes[0].myBVH.nodes[0].BB;
//
//    //std::cout << aa.x << "    " << aa.y << "   " << aa.z << endl;
//    //std::cout << bb.x << "    " << bb.y << "   " << bb.z << endl;
//
//    // draw in wireframe
